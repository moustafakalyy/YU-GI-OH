...
public class MonsterButton1 extends JButton implements MouseListener {
	JFrame x;
	...
	public MonsterButton1(MonsterCard monsterCard){
		...
		if(GUI.getStartFrame().getPlayer1().equals(GUI.getGameBoard().getActivePlayer())){
			if(monsterCard.getMode().equals(Mode.ATTACK)){
				...
				if(x.equals("Declare Attack")){
					if(GUI.getStartFrame().getPlayer2().getField().getMonstersArea().isEmpty()){
						try{
						...
						Object [] hisMonsterArea=arrayofMomsters(GUI.getStartFrame().getPlayer2().getField().getMonstersArea());
						String selected=(String) JOptionPane.showInputDialog(null, "Choose Monster from opponents field","Attack options",GUI.getStartFrame().getPlayer2().getField().getMonstersArea().size(),null,hisMonsterArea,null);
...
//		handButtonOption1.setVisible(true);
	...
	public void mouseEntered(MouseEvent e) {
		if(monsterCard!=null&& GUI.getStartFrame().getPlayer1().equals(GUI.getGameBoard().getActivePlayer()))
	...
	if(monsterCard!=null&& GUI.getStartFrame().getPlayer2().equals(GUI.getGameBoard().getActivePlayer())&&!monsterCard.isHidden())
	...
	public void mousePressed(MouseEvent e) {
		if(!monsterCard.equals(null)&&GUI.getStartFrame().getPlayer1().equals(GUI.getGameBoard().getActivePlayer())||(GUI.getStartFrame().getPlayer2().equals(GUI.getGameBoard().getActivePlayer())&& !getMonsterCard().isHidden())){
